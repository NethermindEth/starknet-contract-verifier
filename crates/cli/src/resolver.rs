...
use voyager_resolver_cairo_2_6_3::dyn_compiler::VoyagerGeneratorWrapper as VoyagerGeneratorV2_6_3;
...
pub fn get_dynamic_compiler(cairo_version: SupportedCairoVersions) -> Box<dyn DynamicCompiler> {
    match cairo_version {
        ...
        SupportedCairoVersions::V2_6_3 => Box::new(VoyagerGeneratorV2_6_3),
        _ => todo!(),
    }
}
