...
impl ToString for SupportedCairoVersions {
    fn to_string(&self) -> String {
        match self {
            ...
            SupportedCairoVersions::V2_4_1 => "2.4.1".into(),
            SupportedCairoVersions::V2_4_2 => "2.4.2".into(),
            SupportedCairoVersions::V2_4_3 => "2.4.3".into(),
        }
    }
}
...
impl ToString for SupportedScarbVersions {
    fn to_string(&self) -> String {
        match self {
            ...
            SupportedScarbVersions::V2_4_1 => "2.4.1".into(),
            SupportedScarbVersions::V2_4_2 => "2.4.2".into(),
            SupportedScarbVersions::V2_4_3 => "2.4.3".into(),
        }
    }
}
